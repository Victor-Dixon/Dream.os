...
MODE_HANDLERS: Dict[str, Callable[[], str]] = {
    "advanced-analysis": run_advanced_analysis,
    "advanced-elimination": run_advanced_elimination,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Single runner for analysis and elimination workflows"
    )
    parser.add_argument(
        "--mode",
