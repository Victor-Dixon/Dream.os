#!/usr/bin/env python3
"""
Batch 4 SSOT Verification Tool

Verifies SSOT files for all groups within Batch 4.
...
def main():
    ...
    print("🔍 Batch 4 SSOT Verification")
    print(f"   Batch: 4")
    ...
    try:
        ...
        batch4 = next((b for b in data['batches'] if b['batch_number'] == 4), None)

        if not batch4:
            print("❌ Error: Batch 4 not found in the prioritization file.")
            sys.exit(1)

        groups_to_verify = batch4['groups']
        ...
        if failed_count == 0:
            print("================================================================================")
            print("✅ BATCH 4 SSOT VERIFICATION PASSED")
            print(f"   All {len(groups_to_verify)} groups have valid SSOT files")
            print("   Batch 4 ready for consolidation assignment\n")
            return 0
        else:
            print("================================================================================")
            print("❌ BATCH 4 SSOT VERIFICATION FAILED")
