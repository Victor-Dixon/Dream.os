#!/usr/bin/env python3
"""Update Swarm Brain with Agent-6 session knowledge"""
...
try:
    ...
    update_file = Path("agent_workspaces/Agent-6/swarm_brain_update_2025-12-26.md")
    if update_file.exists():
        content = update_file.read_text(encoding='utf-8')
        
        # Extract title
        title = "Agent-6 Devlog Posting Enforcement Coordination - 2025-12-26"
