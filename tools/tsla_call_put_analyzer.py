...
def format_discord_message(analysis):
    ...
    signal_emoji = "📈" if analysis["signal"] == "CALL" else "📉" if analysis["signal"] == "PUT" else "❓"
...
def main():
    ...
    # Analyze TSLA
    print("🔍 Running TSLA analysis...")
    analysis = analyze_tsla_simple()
    
    # Display results
    print("\n" + "="*50)
    print(f"📊 TSLA Analysis Results")
    print("="*50)
    ...
    if args.post_discord:
        ...
        print("\n💡 To post to Discord, run with --post-discord flag")
