...
# SSOT: docs/recovery/recovery_registry.yaml#tools-message-queue-launcher-py
# @registry docs/recovery/recovery_registry.yaml#tools-message-queue-launcher-py
