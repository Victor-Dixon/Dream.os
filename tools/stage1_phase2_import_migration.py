...
IMPORT_PATTERN_MAPPINGS = [
    ...
    (r"from src\.core\.utilities\.cleanup_utilities import (.+)", r"from src.core.shared_utilities.cleanup_manager import \1"),
    (r"from src\.core\.utilities\.config_utilities import (.+)", r"from src.core.shared_utilities.configuration_manager_util import \1"),
    (r"from src\.core\.utilities\.error_utilities import (.+)", r"from src.core.shared_utilities.error_handler import \1"),
    (r"from src\.core\.utilities\.init_utilities import (.+)", r"from src.core.shared_utilities.initialization_manager import \1"),
    (r"from src\.core\.utilities\.result_utilities import (.+)", r"from src.core.shared_utilities.result_manager import \1"),
    (r"from src\.core\.utilities\.status_utilities import (.+)", r"from src.core.shared_utilities.status_manager import \1"),
    
    # Config classes with specific imports
    (r"from src\.core\.config_browser import (.+BrowserConfig.+)", r"from src.core.config.config_dataclasses import \1"),
    (r"from src\.infrastructure\.browser\.browser_models import (.+BrowserConfig.+)", r"from src.core.config.config_dataclasses import \1"),
    (r"from src\.core\.config_thresholds import (.+ThresholdConfig.+)", r"from src.core.config.config_dataclasses import \1"),
]
...
def migrate_imports(file_path: Path, matches: List[Tuple[int, str, str]]) -> bool:
    ...
    try:
        ...
        replacements = {line_num - 1: (old, new) for line_num, old, new in matches}
