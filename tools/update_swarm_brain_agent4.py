#!/usr/bin/env python3
"""Update Swarm Brain with Agent-4 session knowledge"""
...
try:
    ...
    # Read swarm brain update file (try closure standard first, then regular update)
    update_file = Path("agent_workspaces/Agent-4/swarm_brain_update_2025-12-26_closure_standard.md")
    if not update_file.exists():
        update_file = Path("agent_workspaces/Agent-4/swarm_brain_update_2025-12-26.md")
