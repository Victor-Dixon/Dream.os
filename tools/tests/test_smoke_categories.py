...
class TestCategoryImports:
    ...
    def test_import_vector_tools(self):
        ...
        from tools.categories import vector_tools
    ...
    def test_import_messaging_tools(self):
        ...
        from tools.categories import messaging_tools
    ...
    def test_import_analysis_tools(self):
        ...
        from tools.categories import analysis_tools
    ...
    def test_import_v2_tools(self):
        ...
        from tools.categories import v2_tools
    ...
    def test_import_agent_ops_tools(self):
        ...
        from tools.categories import agent_ops_tools
    ...
    def test_import_testing_tools(self):
        ...
        from tools.categories import testing_tools
    ...
    def test_import_compliance_tools(self):
        ...
        from tools.categories import compliance_tools
    ...
    def test_import_onboarding_tools(self):
        ...
        from tools.categories import onboarding_tools
    ...
    def test_import_docs_tools(self):
        ...
        from tools.categories import docs_tools
    ...
    def test_import_health_tools(self):
        ...
        from tools.categories import health_tools
...
class TestAdapterInterface:
    ...
    @pytest.mark.parametrize(
        "tool_class_path",
        [
            ("tools.categories.vector_tools", "TaskContextTool"),
            ("tools.categories.messaging_tools", "SendMessageTool"),
            ("tools.categories.analysis_tools", "ProjectScanTool"),
            ("tools.categories.v2_tools", "V2CheckTool"),
            ("tools.categories.agent_ops_tools", "AgentStatusTool"),
            ("tools.categories.testing_tools", "CoverageReportTool"),
            ("tools.categories.compliance_tools", "ComplianceHistoryTool"),
            ("tools.categories.onboarding_tools", "SoftOnboardTool"),
            ("tools.categories.docs_tools", "DocsSearchTool"),
            ("tools.categories.health_tools", "HealthPingTool"),
        ],
    )
