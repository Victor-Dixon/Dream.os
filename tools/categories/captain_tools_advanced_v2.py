"""
Captain Advanced Operations Tools V2
======================================

Consolidated advanced tool adapters for Captain operations: points calculation,
mission assignment, and Markov optimization.

PHASE 4 CONSOLIDATION: Combined captain_tools_advanced.py
Reduced from 1 file (287 lines, 3 classes) to 1 consolidated file
