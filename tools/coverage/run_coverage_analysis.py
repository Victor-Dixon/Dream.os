...
class CoveragePipeline:
    ...
    def discover_gaps(self) -> bool:
        ...
        changed_file_cmd = [
            "python",
            "tools/coverage/changed_file_report.py",
            "--base",
            "HEAD~1",
            "--min",
            str(self.thresholds["changed_code_line_coverage_min"]),
        ]
    ...
    def analyze_gaps(self) -> bool:
        ...
        gap_analyzer_cmd = [
            "python",
            "tools/coverage/gap_analyzer.py",
            "--top",
            "10",
            "--min-coverage",
            "70",
    ...
    def run_mutation_tests(self) -> bool:
        ...
        mutation_cmd = [
            "python",
            "tools/coverage/mutation_gate.py",
            "--min",
            str(self.thresholds["mutation_score_target"]),
            "--defer-on-failure",
        ]
        ...
        commands = [
            ...
            (
                [
                    "coverage",
                    "report",
                    f"--fail-under={self.thresholds['global_line_coverage_min']}",
                ],
