# Header-Variant: full
# Owner: Dream.OS
# Purpose: audit harness inventory.
# SSOT: docs/recovery/recovery_registry.yaml#tools-audit-harness-inventory
# @registry docs/recovery/recovery_registry.yaml#tools-audit-harness-inventory
