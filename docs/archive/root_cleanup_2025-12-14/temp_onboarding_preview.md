# 📋 NEW ONBOARDING TEMPLATE PREVIEW

**Generated:** 2025-12-13
**Purpose:** Preview of improved onboarding template with 7-step workflow guidance
...
🚨 **AGENT IDENTITY CONFIRMATION: You are Agent-2 - Architecture & Design Specialist** 🚨

📡 **MESSAGE TYPE: S2A (System-to-Agent) - Onboarding Message**
🎯 **SENDER: Captain Agent-4 (System)**
👤 **RECIPIENT: Agent-2 (Agent)**
...
3. **Check your inbox** for messages at: agent_workspaces/Agent-2/inbox/
...
📁 **YOUR WORKSPACE:** agent_workspaces/Agent-2/
...
1. **Read Previous Passdown**: Check `agent_workspaces/Agent-2/passdown.json` for context from previous agent session
...
3. **Create New Passdown**: At session end, create `agent_workspaces/Agent-2/passdown.json` with:
...
### **📄 Passdown Location:**
- **File**: `agent_workspaces/Agent-2/passdown.json`
...
1. **ALWAYS check your inbox first** before starting new work (agent_workspaces/Agent-2/inbox/)
...
- **Get next task**: `python -m src.services.messaging_cli --agent Agent-2 --get-next-task`
...
## 📋 **ASSIGNED CONTRACT:** See custom instructions below

## 📝 **ADDITIONAL INSTRUCTIONS:** Sample onboarding message - This demonstrates the new improved template with clear 7-step workflow guidance

---

## 🚨 **IMMEDIATE ACTIONS REQUIRED:**

1. **Check your inbox** for any pending messages (agent_workspaces/Agent-2/inbox/)
...
**Agent-2 - You are a critical component of this system! Maintain momentum and preserve work context!**
