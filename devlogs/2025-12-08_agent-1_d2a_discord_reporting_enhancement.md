...
**1. Enhanced `DISCORD_REPORTING_TEXT` Constant** (User's Exact Format):
- Added prominent header: "DISCORD REPORTING POLICY — CRITICAL VISIBILITY"
- Added visual separators for emphasis
- Clarified: "I may not be at the computer. Discord is the primary visibility channel."
- Emphasized: "Your completion report MUST be posted to Discord when a task slice finishes."
- Added exact command section: "HOW TO POST TO DISCORD (EXACT COMMAND)"
- Included step-by-step instructions with example
- Emphasized: "This may be the ONLY way users see your messages!"

**2. Updated D2A Template**:
- Moved Discord reporting policy to the top (right after No-Ack Policy)
- Removed redundant "Reply Channel" section (consolidated into policy)
- Discord reporting policy now appears prominently before cycle checklist
