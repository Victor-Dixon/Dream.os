...
def main():
    ...
    survey_team = [
        {"name": "Agent-SRC-1", "role": "SOLID", "specialty": "Survey Response Coordinator"},
        {"name": "Agent-SQA-2", "role": "TDD", "specialty": "Survey Quality Assurance"},
        {"name": "Agent-SDA-3", "role": "SSOT", "specialty": "Survey Data Analysis"},
        {"name": "Agent-SRC-4", "role": "SOLID", "specialty": "Survey Report Compilation"},
        {"name": "Agent-SRA-5", "role": "DRY", "specialty": "Survey Risk Assessment"},
        {"name": "Agent-STM-6", "role": "KISS", "specialty": "Survey Timeline Management"},
    ]
    ...
    for i, agent in enumerate(survey_team, 1):
        ...
        success = onboard_survey_agent(agent["name"], agent["role"], agent["specialty"])
