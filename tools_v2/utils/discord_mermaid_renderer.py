...
class DiscordMermaidRenderer:
    ...
    def render_mermaid_to_image_url(self, diagram_code: str) -> Optional[str]:
        ...
        try:
            ...
            if kroki_response.status_code == 200:
                # kroki returns base64 encoded image
    ...
    def render_to_file(self, diagram_code: str, output_path: Path) -> bool:
        """
        ...
        Returns:
            True if successful
        """
        return self.render_mermaid_to_file(diagram_code, output_path)
