...
class TheaLoginHandler:
    ...
    def __init__(self, username: str = None, password: str = None, totp_secret: str = None, cookie_file: str = "thea_cookies.json", timeout: int = 30):
...
__all__ = ["TheaLoginHandler", "TheaCookieManager", "TheaLoginDetector", "TheaAuthenticationHandler"]
