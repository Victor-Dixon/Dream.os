...
class Config:
    ...
    def _load_config(self) -> dict[str, Any]:
        ...
        defaults = {
            "rate_limits": {
                "global": {"requests_per_minute": 60, "burst_size": 10},
                "per_host": {"requests_per_minute": 30, "burst_size": 5},
            },
            "batch": {
            ...
            "llm": {"model": "gpt-4", "max_tokens": 2000, "temperature": 0.1},
            "redaction": {
                "patterns": [
    ...
    def get_rate_limit(self, host: str | None = None) -> dict[str, int]:
        """Get rate limit configuration for a specific host."""
        if host:
            return self.get("rate_limits.per_host", {})
