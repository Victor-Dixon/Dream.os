...
class ContractStorage:
    ...
    def save_contract(self, contract: Contract) -> bool:
        ...
        try:
            ...
            agent_file = self.agent_contracts_dir / f"{contract.agent_id}_contracts.json"
    ...
    def get_agent_summary(self, agent_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            completed_contracts = len([c for c in contracts if c.status == TaskStatus.COMPLETED])
