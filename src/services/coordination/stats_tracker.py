...
class StatsTracker:
    ...
    Manages statistics collection, calculation,
    and reporting for coordination operations.
    """
    ...
    def update_coordination_stats(self, success: bool, coordination_time: float, 
                                strategy: str = None, priority: str = None, 
                                message_type: str = None, sender_type: str = None):
        ...
        self._update_detailed_stats(success, coordination_time, strategy, 
                                  priority, message_type, sender_type)
    ...
    def _update_detailed_stats(self, success: bool, coordination_time: float,
                             strategy: str = None, priority: str = None,
                             message_type: str = None, sender_type: str = None):
    ...
    def _update_category_stats(self, category: str, key: str, success: bool, coordination_time: float):
    ...
    def get_performance_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        avg_time = sum(record["coordination_time"] for record in recent_history) / total_coordinations
