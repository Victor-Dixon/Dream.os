...
class ConversationExtractor:
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        self.message_selector = extraction_config.get('message_selector', '[data-message-author-role]')
    ...
    async def _extract_message_data(self, element, index: int) -> Optional[Dict[str, Any]]:
    ...
    async def extract_conversation(self, page: Page, conversation_id: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            self.logger.info(f"Extracted conversation {conversation_id} with {len(messages)} messages")
            return conversation
