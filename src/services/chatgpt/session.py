...
try:
    ...
    from ...core.config_ssot import get_unified_config  # SSOT: config_ssot.py is the SSOT wrapper
    ...
    class BaseSessionManager:
        ...
        def _generate_session_id(self, service_name):
            return f"{service_name}_{int(time.time())}"
...
class BrowserSessionManager(BaseSessionManager):
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.cookie_storage = session_config.get(
    ...
    def create_session(self, service_name: str = "chatgpt", **kwargs) -> str | None:
        """
