...
class VisionPersistence:
    ...
    def get_previous_image(self, agent_id: str | None, region: tuple | None) -> Any | None:
        """
    ...
    def store_previous_image(self, image: Any, agent_id: str | None, region: tuple | None) -> None:
        """
    ...
    def _get_cache_key(self, agent_id: str | None, region: tuple | None) -> str:
