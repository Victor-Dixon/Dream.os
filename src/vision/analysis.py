...
from .analyzers import ChangeDetector, ColorAnalyzer, EdgeAnalyzer, UIDetector
...
class VisualAnalyzer:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.ui_detector = UIDetector(
            {
                ...
                "high_threshold": analysis_config.get("edge_detection", {}).get(
                    "high_threshold", 150
                ),
            }
        )
        ...
        self.change_detector = ChangeDetector(
            {"default_threshold": 0.1, "diff_threshold": 30, "min_region_size": 10}
        )
    ...
    def detect_changes(
        self, image1: np.ndarray, image2: np.ndarray, threshold: float = 0.1
    ) -> dict:
        """
