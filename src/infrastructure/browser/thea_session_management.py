...
from .browser_models import RateLimitStatus, SessionInfo
...
class TheaSessionManagement:
    ...
    def __init__(self, cookie_file: str = "data/thea_cookies.json", requests_per_minute: int = 10):
...
# Factory function
def create_thea_session_management(
    cookie_file: str = "data/thea_cookies.json", requests_per_minute: int = 10
