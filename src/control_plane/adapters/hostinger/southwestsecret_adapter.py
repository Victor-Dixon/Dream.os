...
Hostinger Site Adapter - SouthwestSecret
========================================
"""
...
class SouthwestSecretHostingerAdapter:
    def __init__(
        self,
        base_url: str,
    ...
    def last_deploy(self) -> Dict[str, Any]:
        meta_path = Path("runtime/deploy_logs/southwestsecret_last.json")
...
def get_southwestsecret_adapter() -> SiteAdapter:
    base_url = "https://southwestsecret.com"
    return SouthwestSecretHostingerAdapter(base_url=base_url)
