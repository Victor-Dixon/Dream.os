...
class AriaJetHostingerAdapter:
    ...
    def last_deploy(self) -> Dict[str, Any]:
        meta_path = Path("runtime/deploy_logs/ariajet_last.json")
...
def get_ariajet_adapter() -> SiteAdapter:
    base_url = "https://ariajet.site"
    return AriaJetHostingerAdapter(base_url=base_url)
