...
class TradingRobotPlugHostingerAdapter:
    def __init__(
        self,
        base_url: str,
    ...
    def last_deploy(self) -> Dict[str, Any]:
        meta_path = Path("runtime/deploy_logs/tradingrobotplug_last.json")
...
def get_tradingrobotplug_adapter() -> SiteAdapter:
    base_url = "https://tradingrobotplug.com"
    return TradingRobotPlugHostingerAdapter(base_url=base_url)
