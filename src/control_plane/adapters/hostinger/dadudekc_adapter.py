...
Hostinger Site Adapter - DadudekC
=================================
"""
...
class DadudekCHostingerAdapter:
    def __init__(
        self,
        base_url: str,
    ...
    def last_deploy(self) -> Dict[str, Any]:
        meta_path = Path("runtime/deploy_logs/dadudekc_last.json")
...
def get_dadudekc_adapter() -> SiteAdapter:
    base_url = "https://dadudekc.com"
    return DadudekCHostingerAdapter(base_url=base_url)
