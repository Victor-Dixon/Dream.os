...
class RecoverySystem:
    ...
    async def _attempt_task_recovery(self, task_id: str, agent_id: str, error_message: str) -> None:
    ...
    async def _check_escalation_threshold(self) -> None:
        ...
        try:
            ...
            recent_failures = [
                f for f in self.failure_history if current_time - f["timestamp"] < 3600  # Last hour
            ]
