...
def create_performance_metrics_engine(config: Optional[PerformanceConfig] = None) -> PerformanceMetricsEngine:
    """Factory function to create performance metrics engine with optional configuration"""
