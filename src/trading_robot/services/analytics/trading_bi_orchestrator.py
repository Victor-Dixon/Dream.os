...
from .trading_bi_models import (
    PerformanceMetrics, RiskMetrics, MarketTrend, PnLResult,
    RiskAssessmentConfig, PerformanceConfig, TrendAnalysisConfig
)
from .risk_analysis_engine import RiskAnalysisEngine, create_risk_analysis_engine
from .performance_metrics_engine import PerformanceMetricsEngine, create_performance_metrics_engine
from .market_trend_engine import MarketTrendEngine, create_market_trend_engine
from ...repositories.trading_repository import TradingRepositoryInterface, Trade, Position
...
class TradingBiAnalyticsOrchestrator:
    ...
    async def generate_comprehensive_report(self, symbols: List[str], portfolio_value: float) -> Dict[str, Any]:
...
def create_trading_bi_analytics_orchestrator(
    ...
    """Factory function to create trading BI analytics orchestrator with dependency injection"""
