...
class ProtocolRegistry:
    ...
    def get_protocol(self, emergency_type: EmergencyType, 
        ...
        try:
            ...
            compatible_protocols = [
                ...
                if (p.emergency_type == emergency_type and 
                    self._severity_meets_threshold(severity, p.severity_threshold))
            ]
    ...
    def remove_protocol(self, emergency_type: EmergencyType, 
                       severity: EmergencySeverity) -> bool:
        """Remove a protocol."""
        try:
            protocol_id = f"{emergency_type.value}_{severity.value}"
            if protocol_id in self.protocols:
