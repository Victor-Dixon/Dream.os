...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-messaging-templates-data-template-d2a
# @registry docs/recovery/recovery_registry.yaml#src-core-messaging-templates-data-template-d2a
