...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-utils-queue-utilities
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-utils-queue-utilities
