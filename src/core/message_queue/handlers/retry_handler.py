...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-handlers-retry-handler
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-handlers-retry-handler
