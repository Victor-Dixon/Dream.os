...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-processing-message-parser
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-processing-message-parser
