...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-processing-message-router
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-processing-message-router
