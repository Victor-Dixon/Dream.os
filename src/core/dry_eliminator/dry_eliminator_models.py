...
def create_dry_analysis_result(violations: List[DRYViolation], 
                              files_analyzed: int, total_lines: int) -> DRYAnalysisResult:
...
__all__ = [
    ...
    "DRYViolation", "DRYAnalysisResult", "DRYConfiguration", "DRYMetrics",
    "create_dry_violation", "create_dry_analysis_result", 
    "create_dry_configuration", "create_dry_metrics"
]