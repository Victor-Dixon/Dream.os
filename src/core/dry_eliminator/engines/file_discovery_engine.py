...
class FileDiscoveryEngine:
    ...
    def get_files_by_size(self, min_size: int = 0, max_size: Optional[int] = None) -> List[Path]:
    ...
    def get_files_by_line_count(self, min_lines: int = 0, max_lines: Optional[int] = None) -> List[Path]:
