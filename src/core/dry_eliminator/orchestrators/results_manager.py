...
class ResultsManager:
    ...
    Handles result tracking, reporting, and status management
    for DRY elimination operations.
    """
        ...
        try:
            ...
            if total_results > 0:
                ...
                if successful_results:
                    total_time = sum(r.processing_time for r in successful_results if hasattr(r, 'processing_time'))
                    if total_time > 0:
    ...
    def _generate_summary_text(self, consolidations: int, removals: int, errors: int, time: float) -> str:
        ...
        try:
            ...
            return f"Processed {self.elimination_results['files_processed']} files, " + ", ".join(parts)
