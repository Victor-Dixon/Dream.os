...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-mock-unified-messaging-core
# @registry docs/recovery/recovery_registry.yaml#src-core-mock-unified-messaging-core
