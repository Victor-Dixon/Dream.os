...
from .agent_context_models import (
    AgentContext, Recommendation, ContextMetrics, AgentProfile,
    RecommendationType, ConfidenceLevel, create_agent_profile,
    create_recommendation, create_agent_context
)
...
class AgentContextSystem:
    ...
    def create_agent_profile(self, agent_id: str, name: str, role: str, **kwargs) -> bool:
