...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-session-base-session-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-session-base-session-manager
...
class BaseSessionManager(ABC):
    ...
    def get_all_sessions(self) -> dict[str, dict[str, Any]]:
        ...
        """
        return {
            session_id: self.get_session_info(session_id) for session_id in self.sessions.keys()
        }
