...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-interfaces
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-interfaces
