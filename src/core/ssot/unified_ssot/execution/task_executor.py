...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-ssot-unified-ssot-execution-task-executor
# @registry docs/recovery/recovery_registry.yaml#src-core-ssot-unified-ssot-execution-task-executor
