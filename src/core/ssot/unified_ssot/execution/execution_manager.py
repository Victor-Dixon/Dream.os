...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-ssot-unified-ssot-execution-execution-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-ssot-unified-ssot-execution-execution-manager
