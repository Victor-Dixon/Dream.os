...
MESSAGE_TEMPLATES: dict[MessageCategory, Any] = {
    ...
    MessageCategory.S2A: {
        ...
        "STALL_RECOVERY": (
            ...
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "**STOP. Ask these 3 questions RIGHT NOW (before starting ANY work):**\n\n"
            "1. **Time Estimate**: Will this take me >1 cycle (3+ hours)?\n"
            "   → If YES: BREAK INTO PIECES, delegate to 2-4 agents IMMEDIATELY\n"
            "   → Don't start working alone on large tasks\n\n"
            "2. **Domain Scope**: Does this touch 2+ agent domains?\n"
            "   → If YES: Message domain specialists to coordinate IMMEDIATELY\n"
            "   → Example: Frontend + Backend → Agent-7 + Agent-1\n\n"
            "3. **Expertise Match**: Is another agent better suited?\n"
            "   → If YES: Message them to take over, offer to assist IMMEDIATELY\n"
            "   → Don't struggle alone when expertise exists\n\n"
            ...
            "(But remember: When in doubt, delegate!)\n\n"
            "Escalation:\n{fallback}\n"
