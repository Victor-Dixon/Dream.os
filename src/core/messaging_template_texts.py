...
MESSAGE_TEMPLATES: dict[MessageCategory, Any] = {
    ...
    MessageCategory.C2A: (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        "🔮 PROACTIVE RISK ASSESSMENT (BEFORE STARTING)\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        ...
        "**Decision Framework**:\n"
        "- If risks are manageable → Proceed with mitigation strategies\n"
        "- If risks are high → Escalate to Captain or coordinate with domain experts\n"
        "- If risks reveal scope expansion → STOP, reassess, and coordinate\n\n"
        ...
        "**Decision Framework**:\n"
        "- **Continue**: If scope/approach/progress are on track → Continue to Validate phase\n"
        "- **Pivot**: If approach needs adjustment → Adjust strategy, continue execution\n"
        "- **Escalate**: If blocked or high-risk → Send A2C message with blocker + proposed fix\n"
        "- **Coordinate**: If scope expanded → STOP, break down, delegate to swarm\n\n"
    ...
    MessageCategory.A2A: (
        ...
        "**Decision Framework**:\n"
        "- If risks are manageable → Proceed with mitigation strategies\n"
        "- If risks are high → Escalate to coordinator or coordinate with domain experts\n"
        "- If risks reveal scope expansion → STOP, reassess, and coordinate\n\n"
        "**AGI-Level Aspect**: Agents anticipate problems before they occur, not just react to them.\n\n"
        "**3. SLICE** → Break work into manageable slices\n"
        "- Identify smallest viable unit of work\n"
        ...
        "- **Continue**: If scope/approach/progress are on track → Continue to Validate phase\n"
        "- **Pivot**: If approach needs adjustment → Adjust strategy, continue execution\n"
        "- **Escalate**: If blocked or high-risk → Send A2A/A2C message with blocker + proposed fix\n"
        "- **Coordinate**: If scope expanded → STOP, break down, expand to swarm coordination\n\n"
        "**AGI-Level Aspect**: Agents adapt dynamically to changing conditions, not just follow initial plan.\n\n"
        "**5. VALIDATE** → Validate your work\n"
        "- Run linting: `python -m py_compile <file>`\n"
        "- Test functionality if applicable\n"
