...
from ..integration_models import (
    IntegrationTask, IntegrationType, IntegrationStatus
)
...
class IntegrationTaskEngine:
    ...
    async def execute_task(self, task: IntegrationTask, vector_integration) -> Dict[str, Any]:
        ...
        try:
            ...
            if task.integration_type == IntegrationType.VECTOR_DATABASE:
                ...
                result = {"status": "unsupported", "integration_type": task.integration_type.value}
    ...
    async def _execute_vector_integration(self, task: IntegrationTask, vector_integration) -> Dict[str, Any]:
