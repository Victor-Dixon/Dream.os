...
class MLLearningCoordinatorCore:
    ...
    def start_learning_session(
        self, session_id: str, model_type: ModelType, configuration: MLConfiguration
    ) -> bool:
    ...
    def get_optimization_metrics(
        self, metrics_id: str
    ) -> Optional[MLOptimizationMetrics]:
    ...
    def get_optimization_metrics_by_session(
        self, session_id: str
    ) -> List[MLOptimizationMetrics]:
