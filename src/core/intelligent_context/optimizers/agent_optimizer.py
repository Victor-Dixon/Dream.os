...
class AgentOptimizer:
    ...
    def get_agent_recommendations(
        self, mission: MissionContext, limit: int = 5
    ...
    def get_agent_availability(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "availability_rate": (
                available_count / max(len(self.engine.agent_capabilities), 1)
            ),
        }
    ...
    def get_agent_performance_summary(self) -> Dict[str, Any]:
        ...
        success_rates = [
            cap.success_rate for cap in self.engine.agent_capabilities.values()
        ]
        workloads = [
            cap.current_workload for cap in self.engine.agent_capabilities.values()
        ]
