...
# Header-Variant: full
# Owner: @dreamos/core
# Purpose: core_models module.
# SSOT: docs/recovery/recovery_registry.yaml#core-models
...
License: MIT
@registry docs/recovery/recovery_registry.yaml#src-core-intelligent-context-core-models
"""
