...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-managers-resource-lock-operations
# @registry docs/recovery/recovery_registry.yaml#src-core-managers-resource-lock-operations
