...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-managers-monitoring-monitoring-state
# @registry docs/recovery/recovery_registry.yaml#src-core-managers-monitoring-monitoring-state
