...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-managers-monitoring-monitoring-query
# @registry docs/recovery/recovery_registry.yaml#src-core-managers-monitoring-monitoring-query
