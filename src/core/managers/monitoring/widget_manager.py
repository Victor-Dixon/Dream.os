...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-managers-monitoring-widget-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-managers-monitoring-widget-manager
