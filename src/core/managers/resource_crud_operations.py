...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-managers-resource-crud-operations
# @registry docs/recovery/recovery_registry.yaml#src-core-managers-resource-crud-operations
