...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-managers-resource-file-operations
# @registry docs/recovery/recovery_registry.yaml#src-core-managers-resource-file-operations
