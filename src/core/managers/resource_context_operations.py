...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-managers-resource-context-operations
# @registry docs/recovery/recovery_registry.yaml#src-core-managers-resource-context-operations
