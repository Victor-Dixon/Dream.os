...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-managers-results-base-results-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-managers-results-base-results-manager
