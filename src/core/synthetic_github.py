...
# Header-Variant: full
# Owner: Dream.OS
# Purpose: synthetic github.
# SSOT: docs/recovery/recovery_registry.yaml#src-core-synthetic-github
# @registry docs/recovery/recovery_registry.yaml#src-core-synthetic-github
