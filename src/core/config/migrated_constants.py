"""
Migrated Configuration: constants.py
...
Migration date: 2025-08-30T17:16:24.075754
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from constants.py
CONFIG_DATA = {}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from constants.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate constants.py: {e}")