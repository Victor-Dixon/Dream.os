"""
Migrated Configuration: performance_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\core\performance\performance_config.py
Migration date: 2025-08-30T17:16:24.030711
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from performance_config.py
CONFIG_DATA = {}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from performance_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate performance_config.py: {e}")