"""
Migrated Configuration: config_models.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\core\config_models.py
Migration date: 2025-08-30T17:16:23.373114
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from config_models.py
CONFIG_DATA = {'JSON': 'json', 'YAML': 'yaml', 'INI': 'ini', 'ENV': 'env', 'BASIC': 'basic', 'STANDARD': 'standard', 'STRICT': 'strict'}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from config_models.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate config_models.py: {e}")