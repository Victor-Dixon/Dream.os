"""
Migrated Configuration: metrics_collector_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\services\metrics_collector_config.py
Migration date: 2025-08-30T17:16:17.809496
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from metrics_collector_config.py
CONFIG_DATA = {}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from metrics_collector_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate metrics_collector_config.py: {e}")