"""
Migrated Configuration: system_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\core\performance\config\system_config.py
Migration date: 2025-08-30T17:16:23.190948
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from system_config.py
CONFIG_DATA = {'DEVELOPMENT': 'development', 'STAGING': 'staging', 'PRODUCTION': 'production', 'TESTING': 'testing', 'DEBUG': 'DEBUG', 'INFO': 'INFO', 'WARNING': 'WARNING', 'ERROR': 'ERROR', 'CRITICAL': 'CRITICAL'}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from system_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate system_config.py: {e}")