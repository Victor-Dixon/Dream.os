"""
Migrated Configuration: validation_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\core\performance\config\validation_config.py
Migration date: 2025-08-30T17:16:22.989767
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from validation_config.py
CONFIG_DATA = {'GREATER_THAN': 'gt', 'LESS_THAN': 'lt', 'EQUAL': 'eq', 'GREATER_THAN_EQUAL': 'gte', 'LESS_THAN_EQUAL': 'lte', 'INFO': 'info', 'WARNING': 'warning', 'CRITICAL': 'critical'}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from validation_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate validation_config.py: {e}")