"""
Migrated Configuration: network_security_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\security\network_security_config.py
Migration date: 2025-08-30T17:16:16.828599
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from network_security_config.py
CONFIG_DATA = {'DEFAULT_MAX_THREADS': 100, 'DEFAULT_TIMEOUT': 5, 'DEFAULT_ANOMALY_THRESHOLD': 0.8, 'THREAT_UPDATE_INTERVAL': 3600}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from network_security_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate network_security_config.py: {e}")