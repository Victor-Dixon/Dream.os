"""
Migrated Configuration: streaming_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\services\multimedia\streaming_config.py
Migration date: 2025-08-30T17:16:17.867545
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from streaming_config.py
CONFIG_DATA = {'VALID_PLATFORMS': ['youtube', 'twitch', 'facebook', 'instagram', 'tiktok', 'custom'], 'VALID_SCHEDULE_TYPES': ['once', 'daily', 'weekly', 'monthly', 'custom']}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from streaming_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate streaming_config.py: {e}")