"""
Migrated Configuration: metrics_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\services\metrics_pipeline\metrics_config.py
Migration date: 2025-08-30T17:16:17.935608
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from metrics_config.py
CONFIG_DATA = {'DEFAULT_EXPORT_PATH': 'metrics_export.json', 'SUMMARY_TOTAL_METRICS': 'total_metrics', 'SUMMARY_METRICS_TRACKED': 'metrics_tracked'}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from metrics_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate metrics_config.py: {e}")