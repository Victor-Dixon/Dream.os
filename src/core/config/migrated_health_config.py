"""
Migrated Configuration: health_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\core\health\monitoring\health_config.py
Migration date: 2025-08-30T17:16:23.736443
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from health_config.py
CONFIG_DATA = {'EXCELLENT': 'excellent', 'GOOD': 'good', 'WARNING': 'warning', 'CRITICAL': 'critical', 'OFFLINE': 'offline', 'RESPONSE_TIME': 'response_time', 'MEMORY_USAGE': 'memory_usage', 'CPU_USAGE': 'cpu_usage', 'ERROR_RATE': 'error_rate', 'TASK_COMPLETION_RATE': 'task_completion_rate', 'HEARTBEAT_FREQUENCY': 'heartbeat_frequency', 'CONTRACT_SUCCESS_RATE': 'contract_success_rate', 'COMMUNICATION_LATENCY': 'communication_latency'}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from health_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate health_config.py: {e}")