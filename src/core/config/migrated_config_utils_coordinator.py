"""
Migrated Configuration: config_utils_coordinator.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\utils\config_utils_coordinator.py
Migration date: 2025-08-30T17:16:23.661375
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from config_utils_coordinator.py
CONFIG_DATA = {}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from config_utils_coordinator.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate config_utils_coordinator.py: {e}")