"""
Migrated Configuration: launch_performance_config.py
...
Migration date: 2025-08-30T17:16:21.560470
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from launch_performance_config.py
CONFIG_DATA = {}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from launch_performance_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate launch_performance_config.py: {e}")