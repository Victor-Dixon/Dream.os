"""
Migrated Configuration: persistent_storage_config.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\core\persistent_storage_config.py
Migration date: 2025-08-30T17:16:21.912786
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from persistent_storage_config.py
CONFIG_DATA = {'FILE_BASED': 'file_based', 'DATABASE': 'database', 'HYBRID': 'hybrid', 'BASIC': 'basic', 'ADVANCED': 'advanced', 'CRITICAL': 'critical'}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from persistent_storage_config.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate persistent_storage_config.py: {e}")