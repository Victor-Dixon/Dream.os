...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from manager.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate manager.py: {e}")