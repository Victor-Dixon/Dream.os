"""
Migrated Configuration: config_manager.py

This file was automatically migrated from the original configuration
file to the centralized configuration system.

Original file: src\core\managers\config_manager.py
Migration date: 2025-08-30T17:16:23.945638
"""

from src.core.config.centralized_config_manager import get_config_manager

# Configuration data from config_manager.py
CONFIG_DATA = {'JSON': 'json', 'YAML': 'yaml', 'TOML': 'toml', 'INI': 'ini', 'ENV': 'env', 'NONE': 'none', 'BASIC': 'basic', 'STRICT': 'strict', 'COMPREHENSIVE': 'comprehensive'}
...
def migrate_to_centralized():
    ...
    for key, value in CONFIG_DATA.items():
        ...
        config_manager.set(key, value, section, description=f"Migrated from config_manager.py")
...
if __name__ != "__main__":
    try:
        ...
        import logging
        logging.warning(f"Failed to auto-migrate config_manager.py: {e}")