...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-stress-test-analysis-report
# @registry docs/recovery/recovery_registry.yaml#src-core-stress-test-analysis-report
