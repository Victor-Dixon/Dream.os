...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-messaging-pyautogui-operations
# @registry docs/recovery/recovery_registry.yaml#src-core-messaging-pyautogui-operations
