...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-statistics
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-statistics
