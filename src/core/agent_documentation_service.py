...
class AgentDocumentationService:
    ...
    def search_documentation(self, agent_id: str, query: str, n_results: int = 5) -> List[Dict[str, Any]]:
        """Search documentation."""
        logger.info(f"Searching documentation for agent {agent_id}: {query}")
        return []
    
    def get_agent_relevant_docs(self, agent_id: str, doc_types: List[str] = None) -> List[Dict[str, Any]]:
