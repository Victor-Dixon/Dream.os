...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-self-healing-operations
# @registry docs/recovery/recovery_registry.yaml#src-core-self-healing-operations
