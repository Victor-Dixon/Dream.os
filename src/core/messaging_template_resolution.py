...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-messaging-template-resolution
# @registry docs/recovery/recovery_registry.yaml#src-core-messaging-template-resolution
