...
class InterfaceRegistry:
    ...
    def register_interface(self, metadata: InterfaceMetadata, definition: InterfaceDefinition) -> bool:
    ...
    def get_interface_definition(self, interface_id: str) -> Optional[InterfaceDefinition]:
        """Get interface definition - simplified."""
        if not self.is_initialized:
            return None
        return self.definitions.get(interface_id)
    
    def list_interfaces(self, interface_type: Optional[InterfaceType] = None) -> List[InterfaceMetadata]:
    ...
    def list_instances(self, interface_id: Optional[str] = None) -> List[InterfaceInstance]:
    ...
    def validate_interface(self, interface_id: str) -> Optional[InterfaceValidationResult]:
    ...
    def get_validation_result(self, interface_id: str) -> Optional[InterfaceValidationResult]:
