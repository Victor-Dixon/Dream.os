...
@file Transition models.
@summary Transition models.
@registry docs/recovery/recovery_registry.yaml#unregistered-src-core-constants-fsm-transition-models
"""
