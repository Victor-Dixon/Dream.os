...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-shared-utilities-status-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-shared-utilities-status-manager
