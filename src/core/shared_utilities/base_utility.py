...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-shared-utilities-base-utility
# @registry docs/recovery/recovery_registry.yaml#src-core-shared-utilities-base-utility
