...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-shared-utilities-initialization-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-shared-utilities-initialization-manager
