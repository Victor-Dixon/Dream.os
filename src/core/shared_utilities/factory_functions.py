...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-shared-utilities-factory-functions
# @registry docs/recovery/recovery_registry.yaml#src-core-shared-utilities-factory-functions
