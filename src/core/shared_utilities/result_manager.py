...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-shared-utilities-result-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-shared-utilities-result-manager
