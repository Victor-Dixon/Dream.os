...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-shared-utilities-cleanup-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-shared-utilities-cleanup-manager
