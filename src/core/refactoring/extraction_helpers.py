...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-refactoring-extraction-helpers
# @registry docs/recovery/recovery_registry.yaml#src-core-refactoring-extraction-helpers
