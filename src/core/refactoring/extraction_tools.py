...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-refactoring-extraction-tools
# @registry docs/recovery/recovery_registry.yaml#src-core-refactoring-extraction-tools
