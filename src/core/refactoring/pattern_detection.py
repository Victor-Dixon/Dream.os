...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-refactoring-pattern-detection
# @registry docs/recovery/recovery_registry.yaml#src-core-refactoring-pattern-detection
