...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-refactoring-analysis-tools-core
# @registry docs/recovery/recovery_registry.yaml#src-core-refactoring-analysis-tools-core
