...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-refactoring-optimization-helpers
# @registry docs/recovery/recovery_registry.yaml#src-core-refactoring-optimization-helpers
