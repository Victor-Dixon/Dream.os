...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-refactoring-tools-extraction-tools
# @registry docs/recovery/recovery_registry.yaml#src-core-refactoring-tools-extraction-tools
