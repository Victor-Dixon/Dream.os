...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-refactoring-metrics-definitions
# @registry docs/recovery/recovery_registry.yaml#src-core-refactoring-metrics-definitions
