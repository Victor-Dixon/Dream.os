...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-self-healing-integration
# @registry docs/recovery/recovery_registry.yaml#src-core-self-healing-integration
