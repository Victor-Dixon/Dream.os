...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-messaging-protocol-models
# @registry docs/recovery/recovery_registry.yaml#src-core-messaging-protocol-models
