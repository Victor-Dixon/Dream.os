...
# Header-Variant: full
# Owner: Dream.OS
# Purpose: simple oversight.
# SSOT: docs/recovery/recovery_registry.yaml#src-core-vector-strategic-oversight-simple-oversight
# @registry docs/recovery/recovery_registry.yaml#src-core-vector-strategic-oversight-simple-oversight
