# Header-Variant: full
# Owner: Dream.OS
# Purpose: engine core recommendations.
# SSOT: docs/recovery/recovery_registry.yaml#src-core-vector-strategic-oversight-unified-strategic-oversight-engine-core-recommendations
# @registry docs/recovery/recovery_registry.yaml#src-core-vector-strategic-oversight-unified-strategic-oversight-engine-core-recommendations
