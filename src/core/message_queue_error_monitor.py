...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-error-monitor
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-error-monitor
