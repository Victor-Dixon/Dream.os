...
class AnalysisCoreEngine(AnalysisEngine):
    ...
    def extract_patterns(self, context: EngineContext, data: Dict[str, Any]) -> EngineResult:
        ...
        try:
            ...
            patterns = [
                {"type": "function", "count": content.count("def "), "pattern_type": pattern_type},
                {"type": "class", "count": content.count("class "), "pattern_type": pattern_type},
                {"type": "import", "count": content.count("import "), "pattern_type": pattern_type}
            ]
