...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-messaging-coordinate-routing
# @registry docs/recovery/recovery_registry.yaml#src-core-messaging-coordinate-routing
