...
DISCORD_REPORTING_TEXT = (
    "DISCORD REPORTING POLICY (CRITICAL):\n"
    "- Discord is the primary visibility channel; user may be away from keyboard.\n"
    "- Post a Discord completion report when a task slice finishes.\n"
    "- Do not assume in-app replies are sufficient.\n\n"
    "When to post:\n"
    ...
    "What to include (short + high signal):\n"
    "- Task\n"
    "- Actions Taken\n"
    "- Commit Message (if code touched)\n"
    "- Status (✅ done or 🟡 blocked + next step)\n"
    "- Links/paths to artifacts if relevant\n\n"
    "Tone rules:\n"
    "- Avoid acknowledgment-only messages.\n"
