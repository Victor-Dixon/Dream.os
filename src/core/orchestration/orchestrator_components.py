...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-orchestration-orchestrator-components
# @registry docs/recovery/recovery_registry.yaml#src-core-orchestration-orchestrator-components
