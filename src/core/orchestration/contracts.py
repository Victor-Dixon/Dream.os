...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-orchestration-contracts
# @registry docs/recovery/recovery_registry.yaml#src-core-orchestration-contracts
