...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-orchestration-base-orchestrator
# @registry docs/recovery/recovery_registry.yaml#src-core-orchestration-base-orchestrator
