...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-orchestration-ai-orchestrator-factory
# @registry docs/recovery/recovery_registry.yaml#src-core-orchestration-ai-orchestrator-factory
