...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-orchestration-orchestrator-lifecycle
# @registry docs/recovery/recovery_registry.yaml#src-core-orchestration-orchestrator-lifecycle
