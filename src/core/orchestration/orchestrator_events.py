...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-orchestration-orchestrator-events
# @registry docs/recovery/recovery_registry.yaml#src-core-orchestration-orchestrator-events
