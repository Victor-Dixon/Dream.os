...
class TaskManager:
    ...
    def execute_task(self, task: IntegrationTask) -> Dict[str, Any]:
        ...
        try:
            ...
            handler = self.integration_handlers.get(
                task.integration_type, self._default_handler
            )

            # Execute operation
            result = handler(task.integration_type, task.operation, task.data)
    ...
    async def execute_task_async(self, task: IntegrationTask) -> Dict[str, Any]:
    ...
    def _default_handler(
        self, integration_type: IntegrationType, operation: str, data: Any
    ) -> Any:
