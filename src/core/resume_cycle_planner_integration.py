...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-resume-cycle-planner-integration
# @registry docs/recovery/recovery_registry.yaml#src-core-resume-cycle-planner-integration
