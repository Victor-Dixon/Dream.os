...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-messaging-delivery-orchestration
# @registry docs/recovery/recovery_registry.yaml#src-core-messaging-delivery-orchestration
