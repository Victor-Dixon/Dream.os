...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-services-message-queue-service
# @registry docs/recovery/recovery_registry.yaml#src-core-services-message-queue-service
