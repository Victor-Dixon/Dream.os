...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-services-template-resolution-service
# @registry docs/recovery/recovery_registry.yaml#src-core-services-template-resolution-service
