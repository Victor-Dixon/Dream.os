...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-services-message-validation-service
# @registry docs/recovery/recovery_registry.yaml#src-core-services-message-validation-service
