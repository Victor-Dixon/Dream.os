...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-pattern-analysis-pattern-analysis-orchestrator
# @registry docs/recovery/recovery_registry.yaml#src-core-pattern-analysis-pattern-analysis-orchestrator
