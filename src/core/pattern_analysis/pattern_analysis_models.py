...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-pattern-analysis-pattern-analysis-models
# @registry docs/recovery/recovery_registry.yaml#src-core-pattern-analysis-pattern-analysis-models
