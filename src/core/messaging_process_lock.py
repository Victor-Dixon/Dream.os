...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-messaging-process-lock
# @registry docs/recovery/recovery_registry.yaml#src-core-messaging-process-lock
