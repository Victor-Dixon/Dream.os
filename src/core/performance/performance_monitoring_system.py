...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-performance-performance-monitoring-system
# @registry docs/recovery/recovery_registry.yaml#src-core-performance-performance-monitoring-system
