...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-performance-unified-dashboard-widget-manager
# @registry docs/recovery/recovery_registry.yaml#src-core-performance-unified-dashboard-widget-manager
