...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-performance-unified-dashboard-init
# @registry docs/recovery/recovery_registry.yaml#src-core-performance-unified-dashboard-init
