...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-performance-performance-dashboard
# @registry docs/recovery/recovery_registry.yaml#src-core-performance-performance-dashboard
