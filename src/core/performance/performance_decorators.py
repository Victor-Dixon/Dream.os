...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-performance-performance-decorators
# @registry docs/recovery/recovery_registry.yaml#src-core-performance-performance-decorators
