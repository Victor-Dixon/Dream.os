...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-performance-coordination-performance-monitor
# @registry docs/recovery/recovery_registry.yaml#src-core-performance-coordination-performance-monitor
