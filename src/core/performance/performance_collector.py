...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-performance-performance-collector
# @registry docs/recovery/recovery_registry.yaml#src-core-performance-performance-collector
