...
# Header-Variant: full
# Owner: @dreamos/core
# Purpose: event_models module.
# SSOT: docs/recovery/recovery_registry.yaml#event-models
...
@registry docs/recovery/recovery_registry.yaml#src-core-infrastructure-event-models
"""
