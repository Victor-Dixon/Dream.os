...
# Header-Variant: full
# Owner: @dreamos/core
# Purpose: event_metrics module.
# SSOT: docs/recovery/recovery_registry.yaml#event-metrics
...
@registry docs/recovery/recovery_registry.yaml#src-core-infrastructure-event-metrics
"""
