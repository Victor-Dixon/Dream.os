...
# Header-Variant: full
# Owner: @dreamos/core
# Purpose: event_persistence module.
# SSOT: docs/recovery/recovery_registry.yaml#event-persistence
...
@registry docs/recovery/recovery_registry.yaml#src-core-infrastructure-event-persistence
"""
