...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-processor-handlers-retry-handler
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-processor-handlers-retry-handler
