...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-processor-processing-delivery-inbox
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-processor-processing-delivery-inbox
