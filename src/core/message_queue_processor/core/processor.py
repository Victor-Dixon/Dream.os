...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-message-queue-processor-core-processor
# @registry docs/recovery/recovery_registry.yaml#src-core-message-queue-processor-core-processor
