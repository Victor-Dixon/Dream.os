...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-smart-assignment-optimizer
# @registry docs/recovery/recovery_registry.yaml#src-core-smart-assignment-optimizer
