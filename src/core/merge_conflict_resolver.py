...
# SSOT: docs/recovery/recovery_registry.yaml#src-core-merge-conflict-resolver
# @registry docs/recovery/recovery_registry.yaml#src-core-merge-conflict-resolver
