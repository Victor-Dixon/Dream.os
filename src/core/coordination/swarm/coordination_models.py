...
def create_coordination_task(task_id: str, description: str, priority: TaskPriority = TaskPriority.MEDIUM) -> CoordinationTask:
...
def create_coordination_result(result_id: str, task_id: str, success: bool, message: str) -> CoordinationResult:
...
def create_agent_coordination_status(agent_id: str, status: str = "active") -> AgentCoordinationStatus:
    """Create an agent coordination status."""
    return AgentCoordinationStatus(
        agent_id=agent_id,
        status=status
    )
