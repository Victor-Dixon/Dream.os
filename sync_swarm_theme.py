...
if __name__ == "__main__":
    # WeAreSwarm.online
    local_swarm = "D:/websites/sites/weareswarm.online/wp/theme/swarm"
    remote_swarm = "domains/weareswarm.online/public_html/wp-content/themes/swarm"
    
    deploy_full_theme("weareswarm.online", local_swarm, remote_swarm)
