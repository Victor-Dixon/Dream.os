...
def main():
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="systems/output_flywheel/dashboard.html",
    ...
    generator = AnalyticsDashboardGenerator(metrics_dir, output_path)
