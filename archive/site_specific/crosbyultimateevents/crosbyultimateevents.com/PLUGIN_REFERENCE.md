...
|--------|---------|----------|
| `deploy_business_plan_plugin.py` | Deploy plugin | `archive/site_specific/crosbyultimateevents/` |
| `verify_plugin_files.py` | Verify files | `archive/site_specific/crosbyultimateevents/` |
| `check_plugin_status.py` | Check status | `archive/site_specific/crosbyultimateevents/` |
| `test_plugin_output.php` | Test output | `archive/site_specific/crosbyultimateevents/` |
| `debug_plugin.php` | Debug plugin | `archive/site_specific/crosbyultimateevents/` |

### Documentation Files

| File | Purpose | Location |
|------|---------|----------|
| `PLUGIN_THEME_INTEGRATION.md` | Integration guide | `archive/site_specific/crosbyultimateevents/` |
| `PLUGIN_DEPLOYMENT_GUIDE.md` | Deployment guide | `archive/site_specific/crosbyultimateevents/` |
| `TROUBLESHOOTING_PLUGIN.md` | Troubleshooting | `archive/site_specific/crosbyultimateevents/` |
| `QUICK_FIX_TEMPLATE_ERROR.md` | Quick fixes | `archive/site_specific/crosbyultimateevents/` |
