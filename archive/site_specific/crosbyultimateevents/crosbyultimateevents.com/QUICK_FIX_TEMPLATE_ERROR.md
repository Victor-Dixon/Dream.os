...
```bash
python archive/site_specific/crosbyultimateevents/verify_plugin_files.py --site crosbyultimateevents.com
```
...
# Check plugin status
python archive/site_specific/crosbyultimateevents/check_plugin_status.py --site crosbyultimateevents.com
```
