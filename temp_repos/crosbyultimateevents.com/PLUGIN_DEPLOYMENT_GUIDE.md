...
python temp_repos/crosbyultimateevents.com/deploy_business_plan_plugin.py --site crosbyultimateevents.com --dry-run
...
```
temp_repos/crosbyultimateevents.com/wordpress-plugins/crosby-business-plan/
...
1. **Zip the plugin:**
   ```bash
   cd temp_repos/crosbyultimateevents.com/wordpress-plugins
