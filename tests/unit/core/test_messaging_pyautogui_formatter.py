...
def test_format_c2a_message_happy_path():
    ...
    result = format_c2a_message(
        recipient="Agent-1", content="Please review the consolidated files."
    )
...
def test_format_c2a_message_with_priority_normal():
    ...
    result = format_c2a_message(recipient="Agent-2", content="Task assigned.", priority="normal")
...
def test_format_c2a_message_with_priority_urgent():
    ...
    result = format_c2a_message(
        recipient="Agent-3", content="Critical bug fix required immediately!", priority="urgent"
    )
...
def test_format_c2a_message_with_priority_high():
    ...
    result = format_c2a_message(
        recipient="Agent-5", content="Please prioritize this task.", priority="high"
    )
...
def test_format_c2a_message_with_priority_low():
    ...
    result = format_c2a_message(
        recipient="Agent-7", content="When you have time, review docs.", priority="low"
    )
...
def test_format_c2a_message_missing_priority():
    ...
    result = format_c2a_message(recipient="Agent-8", content="Standard message.", priority=None)
...
def test_format_c2a_message_empty_content():
    ...
    result = format_c2a_message(recipient="Agent-4", content="")
...
Line 3: Next steps"""
    ...
    result = format_c2a_message(recipient="Agent-6", content=content, priority="high")
...
def test_format_c2a_message_lean_vs_verbose():
    ...
    # Lean format
    lean_result = format_c2a_message(recipient="Agent-1", content="Test message", priority="normal")

    # Old verbose format for comparison
    old_verbose = "[C2A] CAPTAIN → Agent-1\nPriority: normal\n\nTest message"
...
def test_format_c2a_message_all_agent_ids():
    ...
    for agent_id in agent_ids:
        result = format_c2a_message(recipient=agent_id, content=f"Test message for {agent_id}")
...
Then review the output."""
    ...
    result = format_c2a_message(recipient="Agent-2", content=content)
