...
class TestCoreEngines:
    ...
    def test_ml_core_engine(self):
        ...
        result = engine.execute(
            self.context,
            {"operation": "predict", "model_id": "test_model", "features": [1, 2, 3]},
        )
        assert result.success is True
    ...
    def test_analysis_core_engine(self):
        ...
        result = engine.execute(
            self.context,
            {"operation": "analyze", "content": "def test(): pass", "type": "python"},
        )
        assert result.success is True
    ...
    def test_engine_result_structure(self):
        ...
        result = EngineResult(
            success=True, data={"test": "value"}, metrics={"count": 1}, error=None
        )
