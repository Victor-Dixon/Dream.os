"""Lock-in tests for batches 004-013 module contracts."""
...
BATCH_FILES = [ROOT / f"batches/batch_{batch:03d}_paths.txt" for batch in range(4, 14)]
CONTRACT_SNAPSHOT_PATH = ROOT / "tests/snapshots/batch_004_013_module_contracts.json"
REGISTRY_SNAPSHOT_PATH = ROOT / "tests/snapshots/batch_004_013_registry_coverage.json"
