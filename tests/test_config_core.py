...
class TestConfigValidation:
    ...
    def test_type_validation(self):
        ...
        try:
            ...
            assert (
                isinstance(float_val, float) or float_val == 3.14
            ), f"Float conversion: {float_val}"
...
def run_all_tests():
    ...
    for test_method in [
        validation_tests.test_required_config_validation,
    ...
    for test_method in [
        source_tests.test_source_priority,
    ...
    for test_method in [
        runtime_tests.test_set_config_value,
