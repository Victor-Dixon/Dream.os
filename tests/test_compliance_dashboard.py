...
class TestDashboardDataAggregator:
    ...
    def test_aggregate_data(self):
        ...
        complexity_reports = [
            MockComplexityReport(
                "test.py", True, [MockComplexityViolation("HIGH", "cyclomatic", 15)]
            ),
            MockComplexityReport("test2.py", False, []),
        ]

        suggestions = [MockSuggestion("test.py", 500, 200, 0.9, ["module1", "module2"])]
    ...
    def test_top_violators_identification(self):
        ...
        complexity_reports = [
            MockComplexityReport(
                "bad_file.py", True, [MockComplexityViolation("HIGH", "cyclomatic", 20)]
            )
        ]

        suggestions = []

        top_violators = aggregator.identify_top_violators(
