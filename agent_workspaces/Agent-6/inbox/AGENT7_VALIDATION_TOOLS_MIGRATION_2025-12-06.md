...
If you use any of these deprecated tools in your coordination scripts, please migrate to `unified_validator.py`.

**Example Migration**:
```bash
# Old
python tools/session_transition_helper.py --agent Agent-6

# New
python tools/unified_validator.py --category session --agent Agent-6
```
