...
1. ✅ `src/core/vector_database.py` - Now imports from SSOT
2. ✅ `src/services/work_indexer.py` - Now imports from SSOT (removed local duplicate)
...
1. ✅ `src/core/vector_database.py` - Added SSOT tag, imports enums from SSOT
2. ✅ `src/services/work_indexer.py` - Removed local DocumentType duplicate, imports from SSOT
